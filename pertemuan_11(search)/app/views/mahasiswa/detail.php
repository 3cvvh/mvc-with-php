...
<div class="container mt-5">
    <div class="card" style="max-width: 400px; margin: auto;">
        ...
        <div class="card-footer text-end">
            ...
            <a href="http://localhost/tes/road%20to%20laravel/mvc/pertemuan_11(search)/public/mahasiswa/" class="btn btn-secondary btn-sm">Kembali</a>
        </div>
    </div>
</div>
...
document.getElementById('btn-hapus').addEventListener('click', function(e) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "http://localhost/tes/road%20to%20laravel/mvc/pertemuan_11(search)/public/mahasiswa/delete/<?= $mahasiswa['id_mahasiswa'] ?>";
        }
    })
});
</script>