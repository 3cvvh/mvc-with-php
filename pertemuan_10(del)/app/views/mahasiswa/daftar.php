        ...
        <div class="col-6">
            ...
            <ol class="list-group list-group-numbered">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?php echo $mhs['nama'] ?>
                    <a class="" href="http://localhost/tes/road%20to%20laravel/mvc/pertemuan_10(del)/public/mahasiswa/detail/<?php echo $mhs['id_mahasiswa'] ?>">detail</a>
                    <a class="" href="http://localhost/tes/road%20to%20laravel/mvc/pertemuan_10(del)/public/mahasiswa/edit/<?php echo $mhs['id_mahasiswa'] ?>">edit</a>
                </li>
                <?php endforeach; ?>
            </ol>
        </div>
